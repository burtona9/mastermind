document.addEventListener('DOMContentLoaded', function () {
    ...
    function openNextRow(){
        ...
        currentGameRow.classList.remove('d-none');
        focusOnNextDot();
    }
    ...
    function setGameOver(){
        currentDot.classList.remove(DOT_FOCUS_CLASS);
        endOfGameDisplay.classList.add('game-over');
    ...
    restartButton.addEventListener('click', function(){
        ...
        for(let i=0;i<gameRows.length; i++){
            if(i>0){
                gameRows[i].classList.add('d-none');
            }
        }
        enterButton.classList.remove('d-none');
        deleteButton.classList.remove('d-none');
        restartButton.classList.add('d-none');
        endOfGameDisplay.classList.remove('game-over');
